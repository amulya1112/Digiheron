          ...
          <div className="container">
              ...
              >
                ...
                <line x1="2" y1="20" x2="2" y2="20"></line>
                          ...
                          <div className="service__meta">
                              <h1 className="service__text">Social Media Optimization</h1>
                              <Fade bottom>
                              <p className="p service__text p__color">
                                 Uses online channels, platforms
                              </p>
                              </Fade>
              ...
              >
                ...
                <polyline points="2 12 12 17 22 12"></polyline>
                          ...
                          <div className="service__meta">
                              <h1 className="service__text">Branding</h1>
                              <Fade bottom>
                              <p className="p service__text p__color">
              ...
              >
                ...
                <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                          ...
                          <div className="service__meta">
                              <h1 className="service__text">Advertisement</h1>
                              <Fade bottom>
                              <p className="p service__text p__color">
              ...
              >
                ...
                <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                          ...
                          <div className="service__meta">
                              <h1 className="service__text">Paid Search Campaign</h1>
                              <Fade bottom>
                              <p className="p service__text p__color">
              ...
              >
                ...
                <line x1="12" y1="17" x2="12" y2="21"></line>
                          ...
                          <div className="service__meta">
                              <h1 className="skills__text">Market Research</h1>
                              <Fade bottom>
